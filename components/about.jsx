...
export const About = () => {
    return (
        ...
        <div className="xl:container m-auto  text-gray-600 ">
          <div className="bg-purple-100  lg:p-16  space-y-6 lg:flex sm:gap-6 justify-center md:space-y-0 lg:items-center">
            ...
            <div className="mx-5 md:7/12 lg:w-1/2">
              <h2 className="text-3xl font-bold  text-gray-900  md:text-5xl text-left">
                About Us
              </h2>
              ...
              <a
                  ...
                  className="relative flex h-12  w-auto items-center justify-center px-8 before:absolute before:inset-0 before:rounded-full before:bg-blue-100 
