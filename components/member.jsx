    ...
    const features = [
        {
            ...
            title: "Developers",
            desc: "Any developer who have some skills and want to improve their skills and work on good projects."
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            title: "Enterprenuers",
            desc: "Founder or any creative mind have some amazing idea to work on."
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            title: "Recuriters",
            desc: "HR in search of imaginative minds with verifiable work proof."
        },
    ]
